...
export default function PricingPage() {
  ...
  const memberCols = (foundingOpen ? 1 : 0) + (earlyOpen ? 1 : 0) + 1;
      ...
      <Box sx={{ bgcolor: COLORS.primary, color: "#FFFFFF", py: { xs: 6, md: 8 } }}>
        <Container maxWidth="lg">
          ...
          <Box
            sx={{
              display: "grid",
              gridTemplateColumns: { xs: "1fr", md: `repeat(${memberCols}, 1fr)` },
              gap: 2.5,
              mt: 3,
            }}
          >
            {foundingOpen && (
              <MemberPlanCard
                ...
                ctaHref="/member/login?intent=founding"
              />
            )}
            {earlyOpen && (
              <MemberPlanCard
                ...
                ctaHref="/member/login?intent=early"
              />
            )}
            <MemberPlanCard
              tier="standard"
              ...
              ctaHref="/member/login?intent=standard"
            />
          </Box>
