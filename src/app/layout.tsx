...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "24/7 expert helpline, exclusive partner discounts, and a directory of 500+ practice owners. Founding rate $49/mo, never increases while active. First 100 only.",
    images: [
      {
